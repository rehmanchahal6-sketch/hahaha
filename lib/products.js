...
/** Product-specific catalog photos in /public/images/products/ */
export const productImages = {
  'natural-dog-treats-variety-pack': '/images/products/natural-dog-treats-variety-pack.png',
  'salmon-cat-treats': '/images/products/salmon-cat-treats.png',
  'interactive-cat-feather-wand': '/images/products/interactive-cat-feather-wand.png',
  'cat-scratching-post-compact': '/images/products/cat-scratching-post-compact.png',
  'gentle-pet-grooming-brush': '/images/products/gentle-pet-grooming-brush.png',
  'pet-shampoo-sensitive-skin': '/images/products/pet-shampoo-sensitive-skin.png',
  'orthopedic-pet-bed-medium': '/images/products/orthopedic-pet-bed-medium.png',
  'portable-pet-travel-carrier': '/images/products/portable-pet-travel-carrier.png',
  'pet-dental-chew-sticks': '/images/products/pet-dental-chew-sticks.png',
  'stainless-steel-pet-bowl-set': '/images/products/stainless-steel-pet-bowl-set.png',
  'joint-support-pet-supplement': '/images/products/joint-support-pet-supplement.png',
  'slow-feeder-pet-bowl': '/images/products/slow-feeder-pet-bowl.png',
};
...
export function getProductImage(product) {
  return (
    ...
    '/images/category_food_treats.png'
  );
}
