export const company = {
  ...
  email: 'sujan@paudelon.com',
  supportEmail: 'support@paudelon.com',
  phone: '+13075003904',
  phoneDisplay: '+1 (307) 500-3904',
  ...
  addressPurpose:
    'Official registered office and administrative mailing address in Wyoming. Not a public retail storefront.',
  operationalDisclaimer:
    'Paudelon LLC is a registered Wyoming limited liability company. The physical address at 30 N Gould St Ste R, Sheridan, WY 82801 serves as the company\'s official registered office and administrative mailing address. Paudelon LLC operates as a digital-first e-commerce business serving customers remotely through online channels, Shopify, and marketplace storefronts. No walk-in retail services are conducted at the registered office address.',
  businessActivity:
  ...
  operationsModel:
    'Digital-first e-commerce operations serving US customers remotely through Shopify, Amazon, and wholesale channels. No walk-in retail at the registered office.',
};
...
export const faqItems = [
  ...
  },
  {
    ...
    a: `${company.legalName} is registered in ${company.jurisdiction}. Our registered office and mailing address is ${addressBlock}. ${company.operationalDisclaimer}`,
  },
  {
    category: 'Company',
  ...
  },
  {
    ...
    a: `For order and product support, email ${company.supportEmail}. For business, wholesale, and verification inquiries, email ${company.email} or call ${company.phoneDisplay}. You may also use the contact form at ${company.websiteDisplay}/contact or visit ${company.websiteDisplay}/company.`,
  },
  {
    category: 'Contact',
