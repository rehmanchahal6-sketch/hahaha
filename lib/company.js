export const company = {
  ...
  /** Primary business email on company domain — set up forwarding to your inbox */
  email: 'hello@paudelon.com',
  /** Operations inbox — Formspree and direct support */
  supportEmail: 'sujanpaudel368@gmail.com',
  /**
...
export const faqItems = [
  ...
  },
  {
    ...
    a: `${company.legalName} is managed by ${company.managingMember}, managing member. Business inquiries may be directed to ${company.email} or ${company.supportEmail}.`,
  },
  {
    category: 'Company',
  ...
  },
  {
    ...
    a: `Authorized parties may contact ${company.email} or ${company.supportEmail} with their organization name and verification request. We respond with company details and can provide standard formation and tax documentation upon request.`,
  },
  {
    category: 'General',
  ...
  },
  {
    ...
    a: `Email ${company.email} or ${company.supportEmail}, use the contact form at ${company.websiteDisplay}/contact, or visit our Corporate Information page at ${company.websiteDisplay}/company.`,
  },
  {
    category: 'Contact',
