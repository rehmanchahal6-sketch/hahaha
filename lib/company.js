...
export const faqItems = [
  ...
  },
  {
    ...
    a: `For order and product support, email ${company.supportEmail}. For business, wholesale, and verification inquiries, email ${company.email}. You may also use the contact form at ${company.websiteDisplay}/contact or visit ${company.websiteDisplay}/company.`,
  },
  {
    category: 'Contact',
